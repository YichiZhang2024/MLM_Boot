...
Based on the bootstrap samples, we can estimate the sample mean with the average of the bootstrap sample means, $\hat \mu^*=\frac{1}{B}\sum_b^B \hat \mu^*_b$, and the standard error of the mean with the standard deviation of the bootstrap sample means,
