...
To correct the bias contained in the percentile CI, @efron1993 proposed the bias-corrected and accelerated (BCa) CI. They defined two quantiles, $\alpha_L$ and $1-\alpha_U$, as
$$
  \begin{aligned}
