...
To correct the bias contained in the percentile CI, @efron1993 proposed the bias-corrected and accelerated (BCa) CI. Different from the percentile CI that uses  $\frac{1}{2}\alpha$ and $1-\frac{1}{2}\alpha$ quantiles, $\alpha_L$ and $1-\alpha_U$ are selected to construct the BCa CI. @efron1993 defined $\alpha_L$ and $1-\alpha_U$ as
$$
  \begin{aligned}
