...
$$[\hat \theta - t_{1-\frac{1}{2}\alpha}\hat{se}(\hat \theta^*), \hat \theta + t_{1-\frac{1}{2}\alpha}\hat{se}(\hat \theta^*)],$$ where $\hat{se}(\hat \theta^*)$ is the bootstrap estimator of the asymptotic standard errors of $\hat \theta^*$. 
