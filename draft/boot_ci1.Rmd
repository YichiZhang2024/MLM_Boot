...
The percentile CI is formed by using quantiles directly from the bootstrapped distribution [@efron1982]. $$[\hat \theta_T^*(T,\frac{1}{2}\alpha); \hat H^{-1}(1- \frac{1}{2}\alpha)]$$ Although this percentile CI does not assume asymptotic normality of $\hat \theta$, it has been found to generate biased results [@efron1993].
