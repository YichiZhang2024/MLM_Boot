...
3. Draw level-2 residuals $U_j^*$ from the reflated empirical residuals with replacement.
4. Draw level-1 residuals $\epsilon_{ij}$ from the reflated empirical residuals with replacement.
5. Generate the bootstrap samples, $y^*$, with $y_j^* = X_j\hat\beta + Z_jU_j^* + \epsilon_j^*$.
