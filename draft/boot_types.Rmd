We now describe the procedure of parametric bootstrap, residuals bootstrap, wild bootstrap and cases bootstrap in detail. A two-level random-slope model is used to illustrate these different types of bootstrap algorithms.
