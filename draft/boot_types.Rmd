...
\end{equation}
where $\circ$ is the entry-wise product [@modugno2015]. The two commonly used auxiliary distributions are $F_1$, proposed by @mammen1993, and $F_2$ (also known as the Rademacher distribution), proposed by @liu1988, where 
\begin{equation}
  F_1: m =
  \begin{cases}
